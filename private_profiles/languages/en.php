...
$english = array(
	'private_profiles:default_access_setting' => 'Should by default the access to profile pages of community members be unrestricted (still restricted to logged-in members only), restricted to friends of the member or restricted to the member (and admins) only?',
	...
	'private_profiles:user_access_setting' => 'Do you want to give access to your profile page to every member, only to your friends or only to yourself (and site admins)?',
	'private_profiles:user_access_setting_no' => 'Only to myself',
	'private_profiles:user_access_setting_friends' => 'To my friends',
	'private_profiles:user_access_setting_yes' => 'Every member',
	...
	'private_profiles:default_access_setting:current_no' => 'Per site-wide setting the access to your profile page is currently blocked for everyone else but you.',
	'private_profiles:default_access_setting:current_friends' => 'Per site-wide setting the access to your profile page is currently only allowed for you and your friends.',
	'private_profiles:default_access_setting:current_yes' => 'Per site-wide setting the access to your profile page is currently allowed to any member of the site (still restricted to logged-in members only).',
